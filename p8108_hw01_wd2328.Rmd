...
d. 
   ...
   Using R, we can see the 25th percentile (22 months), the median or 50th percentile (90 months), and the 75th percentile (180 months). This is shown above on the plot by the horizontal dashed lines.
...
g. Cumulative Hazard plots
    ...
    i.
      ```{r warning=FALSE}
      km_loglog |>
        ggsurvplot(data = q2_df, fun = "cumhaz",
